...
import 'enter_withdraw_bank_amount_screen.dart';

/// Screen for entering bank account information for withdrawal
class EnterWithdrawBankAccountInfoScreen extends StatefulWidget {
  ...
  @override
  State<EnterWithdrawBankAccountInfoScreen> createState() =>
      _EnterWithdrawBankAccountInfoScreenState();
}

class _EnterWithdrawBankAccountInfoScreenState
    extends State<EnterWithdrawBankAccountInfoScreen> {
