...
class MutualFundReviewOrderScreen extends StatelessWidget {
  ...
  const MutualFundReviewOrderScreen({
    super.key,
  ...
  void _handleConfirm(BuildContext context) {
    ...
    NavigationHelper.navigateTo(
      ...
      ConfettiSuccessScreen(
        ...
        description: context.localize.orderSubmittedFundManager,
        ...
        secondaryButtonText: context.localize.tradeOtherFunds,
